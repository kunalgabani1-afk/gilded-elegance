    ...
    <section className="relative py-32 texture-velvet text-pearl overflow-hidden">
      <div className="mx-auto max-w-7xl px-6 relative">
        <div className="flex flex-wrap items-end justify-between mb-14 gap-6">
          <div>
            <p className="text-xs uppercase tracking-[0.5em] text-gold">In Motion</p>
            <h2 className="mt-4 font-display text-5xl md:text-6xl text-gold-gradient">The Maison Reels</h2>
            <div className="mt-4 gold-divider w-40" />
          </div>
          <a href="#" className="text-xs uppercase tracking-[0.4em] text-gold gold-underline">View All Films</a>
        </div>
          ...
          {reels.map((r, i) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center opacity-90 group-hover:opacity-100 transition">
                <div className="w-16 h-16 rounded-full bg-pearl/15 backdrop-blur border border-gold flex items-center justify-center group-hover:scale-110 group-hover:bg-gold transition-all">
                  <Play size={20} className="text-gold group-hover:text-charcoal ml-1" />
                </div>
              </div>
              <div className="absolute bottom-0 left-0 right-0 p-5">
                <div className="text-[10px] uppercase tracking-[0.4em] text-gold">{r.tag}</div>
